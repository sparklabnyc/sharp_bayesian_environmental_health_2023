...
::: incremental
- Frequentist framework: If we were to repeat the data collection process 100 times and construct condfidence intervals for each sample, 95 of those would contain the true parameter (i.e., the target parameter is fixed but unknown, and the interval is random).
