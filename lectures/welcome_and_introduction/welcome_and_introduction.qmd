...
- __Course materials__. All Material (lectures/labs) is located on Posit Cloud. You were invited to the ‘sharp_bayesian_environmental_health_2023’ Workspace via email on Sunday 18th August.
...
## Bayesian Modelling Workshop Team (to update)
...
## 9 US States + 1 country (to update)

![](assets/attendee_map.png)

## 10 US States + 5 countries (to update)
...
## What is your experience level with R? (to update) {.smaller}
...
## What does a 50% chance of rain mean to you? (to update) {.smaller}
...
## What do you understand from a 95% Confidence Interval (CI)? (to update) {.smaller}
...
## What do you understand from a 95% Confidence Interval (CI)? (to update)
