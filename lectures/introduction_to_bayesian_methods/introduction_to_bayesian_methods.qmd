...
## `R` with `NIMBLE` (from lab after this)
...
- Version control to interface with Post (RStudio) Cloud.
...
-  Interpretability.
-  Flexibility.
-  There are other Bayesian packages, as you will see on Day 2... 
...
3. Test out how adjustments of models are made via different priors and more samples.
