...
#	Brief discussion of R
#	Brief discussion of RStudio Cloud
# Regression
# Generalised linear models
#	Brief history of Bayesian thinking
...
#	Why sample?
#	MCMC, Gibbs, others briefly (Laplace approximation?)
#	Discussion of R-Nimble
#	Why we’re using it for everything over two days
...
![](assets/stan.png){.fragment .absolute top="75%" left="72%" width="6%"}
![](assets/winbugs.png){.fragment .absolute top="82%" left="10%" width="6%"}
![](assets/nimble.jpeg){.fragment .absolute top="63%" left="55%" width="6%"}
...
![](assets/stan.png){.absolute top="75%" left="72%" width="6%"}
![](assets/winbugs.png){.absolute top="82%" left="10%" width="6%"}
![](assets/nimble.jpeg){.absolute top="63%" left="55%" width="6%"}
