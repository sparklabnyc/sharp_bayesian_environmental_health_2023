...
nimbleMCMC_samples_linear <- invisible(nimbleMCMC(
  code = code_linear,
  data = data,
  constants = constants,
  inits = inits,
...
::: nonincremental
- Logistic regression is used when we want to classify observations into two groups (zero or one).
...
## Priors focus in `NIMBLE` model:Non-linear regression
