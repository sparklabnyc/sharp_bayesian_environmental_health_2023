...
<!-- 1. linear exposure-response regression for a single location; -->
<!-- 2. Non-linear exposure-response regression for a single location; -->
1. Linear exposure-response regression for multiple locations;
2. Piecewise exposure-response regressions for multiple locations;
3. Linear exposure-response regression for multiple locations with location-specific associations; and
4. Non-linear exposure-response regression for multiple locations.

## Introduction

We will again use the COVID-19 deaths during March-July 2020, in England, at the LTLA geographical level (317 areas), as taken from the published paper:
...
# 3.  Linear exposure-response regression for multiple locations
...
# 5. Linear exposure-response regression for multiple locations with location-specific associations
...
We fitted several models, some taking the whole of London/England as a single area, some using spatial models, and some with either linear or non-linear models.
